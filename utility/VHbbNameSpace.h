...
double M(	double pt_1, double eta_1, double phi_1, double mass_1,
					double pt_2, double eta_2, double phi_2, double mass_2)
	{
		TLorentzVector p1, p2, p_sum;
...
double pT(double pt_1, double pt_2)
	{
		return pt_1 + pt_2;
	}
